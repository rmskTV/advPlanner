...
{
    /**
     * Получение списка моделей продаж по ID организации
     *
     ...
     *
     * @OA\Get(
     *     path="/api/salesModels/byOrganisations/{organisation_id}",
     *     tags={"Core/Dictionary/SalesModels"},
     *     summary="Получение списка моделей продаж по ID организации",
     *     description="Метод для получения списка списка моделей продаж по ID организации.",
     *
     *     @OA\Parameter(
